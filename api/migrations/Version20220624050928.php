 ...
 */
final class Version20220624050928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE respondent (id INT AUTO_INCREMENT NOT NULL, review_id INT DEFAULT NULL, user_id INT DEFAULT NULL, comment VARCHAR(512) DEFAULT NULL, user_comment VARCHAR(255) DEFAULT NULL, active TINYINT(1) NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_409B51503E2E969B (review_id), INDEX IDX_409B5150A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, specialization_id INT DEFAULT NULL, grade_id INT DEFAULT NULL, subject_id INT DEFAULT NULL, date_start DATETIME NOT NULL, date_end DATETIME DEFAULT NULL, self_review VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, history LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_794381C6FA846217 (specialization_id), INDEX IDX_794381C6FE19A1A8 (grade_id), INDEX IDX_794381C623EDC87 (subject_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
