 ...
 */
final class Version20220703073456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review_respondents (review_id INT NOT NULL, respondent_id INT NOT NULL, INDEX IDX_EE3E9D23E2E969B (review_id), INDEX IDX_EE3E9D2CE80CD19 (respondent_id), PRIMARY KEY(review_id, respondent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE review_respondents DROP FOREIGN KEY FK_EE3E9D23E2E969B');
